...
## Introduction
The script is written to remove overlapping TE regions in the EDTA results to fit the buildsummary.pl summary script. More details see https://github.com/Dfam-consortium/RepeatMasker/issues/343
